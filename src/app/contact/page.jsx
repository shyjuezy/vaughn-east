                ...
                <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                    <div className="relative px-6 pb-20 sm:pt-8 lg:static lg:px-8">
                        <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                            <div
                                className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-gray-900/10 dark:ring-white/5 lg:w-1/2">
                                <div
                            ...
                            <p className="mt-6 text-lg leading-8">
                                Please use this form to contact your local HOA board. The board will do their best to
                                respond to your email within a few days.
                            </p>
